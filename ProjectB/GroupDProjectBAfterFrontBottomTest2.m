%Group D Project B After Back Bottom
%Alex and Briana
load('GroupDProjectBAfterFrontBottom2.mat')
Trace_1(1:end,2)= Trace_1(1:end,2)-mean(Trace_1(1:end,2)); %Center around 0
...
title('Trial AFB Experimental and Actual vs Time');
hold on;
